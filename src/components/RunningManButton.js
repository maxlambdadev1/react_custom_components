...
import styles from "../style/RunningManButton.module.css";
import classNames from "classnames";

const RunningManButton = () => {
    ...
    return (
        <>
            <button className={classNames(styles["running-button"], styles[keyStatus], isActive?styles['active']:'')} 
                onClick={handleClick}
            >
                <span className={styles["default"]}>Start</span>
                <span className={styles["active"]}>Tracking</span>
...
export default RunningManButton;