...
const ButtonHoldToConfirm = ({ gridTitle, listTitle }) => {
    ...
    return (
        <button class={classNames(styles["button-hold"], styles[keyStatus], isProcess?styles['process']:'', isSuccess?styles['success']:'')}
        ...
        >
            <div>
                <svg class={styles["icon"]} viewBox="0 0 16 16">
                    <polygon points="1.3,6.7 2.7,8.1 7,3.8 7,16 9,16 9,3.8 13.3,8.1 14.7,6.7 8,0"></polygon>
                </svg>
                <svg class={styles["progress"]} viewBox="0 0 32 32">
                    <circle r="8" cx="16" cy="16" />
                </svg>
                <svg class={styles["tick"]} viewBox="0 0 24 24">
