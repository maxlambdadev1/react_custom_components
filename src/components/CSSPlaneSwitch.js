...
import styles from "../style/CSSPlaneSwitch.module.css";
import classNames from "classnames";

const CSSPlaneSwitch = () => {
    ...
    return (
        <label className={classNames(styles["plane-switch"], styles[keyStatus])} >
            <input type="checkbox"
            ...
            <div>
                ...
                <span className={styles["street-middle"]}></span>
                <span className={styles["cloud"]}></span>
                <span className={classNames(styles["cloud"], styles["two"])}></span>
            </div>
        </label>
    )
}

export default CSSPlaneSwitch;