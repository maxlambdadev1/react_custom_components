...
import styles from "../style/HeartFoldButton.module.css";
import classNames from "classnames";

const HeartFoldButton = () => {
    ...
    return (
        <button className={classNames(styles["heart"], styles[keyStatus], isActive? styles['active']:'')}
...
export default HeartFoldButton;